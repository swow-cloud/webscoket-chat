                ...
                <div class="card-body">
                  <div class="media">
                    ...
                    <div class="media-body overflow-hidden">
                      ...
                      <div class="text-truncate"><i class="zmdi zmdi-file-text me-1"></i> Lorem ipsum
                ...
                <div class="card-body">
                  <div class="media">
                    ...
                    <div class="media-body overflow-hidden">
                      ...
                      <div class="text-truncate"><i class="zmdi zmdi-phone-end me-1"></i> Lorem ipsum
        ...
        <div class="tab-pane fade" id="nav-tab-pages" role="tabpanel">
          ...
          <div class="card border-0">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item border-0">
                <a class="link" href="pages/password-reset.html"><i class="zmdi zmdi-label-alt me-2"></i>
                  Reset Password</a>
              </li>
              <li class="list-group-item border-0">
              ...
              <li class="list-group-item border-0">
                <a class="link" href="pages/single-chat.html"><i class="zmdi zmdi-label-alt me-2"></i>
                  Single Chat Room</a>
              </li>
              <li class="list-group-item border-0">
                <a class="link" href="pages/group-chat.html"><i class="zmdi zmdi-label-alt me-2"></i> Group
                  Chat Room</a>
              </li>
              <li class="list-group-item border-0">
                <a class="link" href="pages/audio-call.html"><i class="zmdi zmdi-label-alt me-2"></i> Audio
                  Call Room</a>
              </li>
              <li class="list-group-item border-0">
                <a class="link" href="pages/video-call.html"><i class="zmdi zmdi-label-alt me-2"></i> Video
                  Call Room</a>
              </li>
            </ul>
          </div>
                ...
                <div class="row align-items-center">
                  <div class="col">
                    <div class="d-flex align-items-center">
                      <img src="../assets/img/avatar5.png" data-toggle="tooltip" title="" alt="Avatar"
                           class="rounded-circle avatar" data-original-title="Avatar Name">
                      <div class="ms-3">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Lorem, ipsum, dolor sit amet consectetur
                  adipisicing.</small>
              </div>
            </form>
            <div class="mt-5">
